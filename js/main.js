...
(function () {
  ...
  /* ---------- marketplace picker (India + Global) ---------- */
  var MARKET_GROUPS = [
    { region: "India", note: "Marketplaces your customers shop at home", markets: [
      { n: "Amazon", s: "Amazon India Seller & Vendor Central, FBA, A+ content, Sponsored Ads and full account management." },
      { n: "Flipkart", s: "India marketplace launch, Flipkart Ads and festive-season (Big Billion Days) scale strategy." },
      { n: "Meesho", s: "Zero-commission catalog scaling and value-tier positioning for India." },
      { n: "Myntra", s: "Fashion & lifestyle onboarding, catalog styling and PPM growth on India's #1 fashion marketplace." },
      { n: "Ajio", s: "Reliance AJIO brand onboarding, curated fashion listings and marketing to a premium shopper base." },
      { n: "Blinkit", s: "Quick-commerce onboarding, dark-store assortment and instant-delivery merchandising." },
      { n: "JioMart", s: "Reliance JioMart marketplace setup, catalog upload and everyday-essentials growth." },
      { n: "eBay", s: "Cross-border eBay listings, global shipping setup and export-ready growth from India." }
    ]},
    { region: "Global", note: "Sell into the US and worldwide", markets: [
      { n: "Amazon", s: "Amazon US & global Seller/Vendor Central, FBA, A+ content, DSP advertising and full account management." },
